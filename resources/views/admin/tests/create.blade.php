        ...
        <form method="POST" action="{{ route("admin.tests.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Test::RADIO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('radio') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="radio_{{ $key }}" name="radio" value="{{ $key }}" {{ old('radio', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('checkbox') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="checkbox" id="checkbox" value="1" {{ old('checkbox', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('textarea') ? 'is-invalid' : '' }}" name="textarea" id="textarea">{{ old('textarea') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('integer') ? 'is-invalid' : '' }}" type="number" name="integer" id="integer" value="{{ old('integer', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('float') ? 'is-invalid' : '' }}" type="number" name="float" id="float" value="{{ old('float', '') }}" step="0.01">
                @if($errors->has('float'))
                    <div class="invalid-feedback">
                        {{ $errors->first('float') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_picker') ? 'is-invalid' : '' }}" type="text" name="data_picker" id="data_picker" value="{{ old('data_picker') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_time_picker') ? 'is-invalid' : '' }}" type="text" name="data_time_picker" id="data_time_picker" value="{{ old('data_time_picker') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_picker') ? 'is-invalid' : '' }}" type="text" name="time_picker" id="time_picker" value="{{ old('time_picker') }}">
